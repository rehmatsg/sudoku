...
class AppTheme {
  ...
  static ThemeData build({
    ...
    Color surface = brightness == Brightness.light ? HexColor.fromHex('#fef7f1') : HexColor.fromHex('#161a20');
    ...
    ColorScheme colorScheme = ColorScheme.fromSeed(seedColor: seed, brightness: brightness).copyWith(
      ...
      outline: brightness == Brightness.light ? HexColor.fromHex('#d5d5d5') : null,
      tertiaryContainer: HexColor.fromHex('#f2e8e1')
    );
    return ThemeData(
